...
Trying to deploy a local ZenML server on a local K3s cluster.
...
k3d cluster create zenml-local --api-port 6550 --port "8080:80@loadbalancer"
...
cp zenml/values-local.yaml values-local.yaml
